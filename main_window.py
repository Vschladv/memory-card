...
btn_menu.setStyleSheet('color: red;')  # Make the button text red
btn_rest = QPushButton('Відпочити')
btn_rest.setStyleSheet('color: red;')  # Make the button text red
btn_next = QPushButton('Відповісти')
btn_next.setStyleSheet('color: red;')  # Make the button text red

rb_ans1 = QRadioButton("1")
rb_ans1.setStyleSheet('color: red;')  # Make the radio button text red
rb_ans2 = QRadioButton("2")
rb_ans2.setStyleSheet('color: red;')  # Make the radio button text red
rb_ans3 = QRadioButton("3")
rb_ans3.setStyleSheet('color: red;')  # Make the radio button text red
rb_ans4 = QRadioButton("4")
rb_ans4.setStyleSheet('color: red;')  # Make the radio button text red
...
lb_question.setStyleSheet('color: red;')  # Make the label text red

lb_rest = QLabel('хвилин')
lb_rest.setStyleSheet('color: red;')  # Make the label text red

lb_result = QLabel('Правильно')
lb_result.setStyleSheet('color: red;')  # Make the label text red

lb_right_answer = QLabel('відповідь')
lb_right_answer.setStyleSheet('color: red;')  # Make the label text red

sp_rest = QSpinBox()

gb_question = QGroupBox('Варіанти відповідей')
gb_question.setStyleSheet('color: red;')  # Make the group box text red
...
gb_answer = QGroupBox()
gb_answer.setStyleSheet('color: red;')  # Make the group box text red
